...
#*** Start page
start_page = `curl "https://welcome23.smile.co.uk/SmileWeb/start.do" -c"#{cookie_path}"`
...
security_number_page = `curl "https://welcome23.smile.co.uk/SmileWeb/login.do" \
...
curl_cmd = %%curl "https://welcome23.smile.co.uk/SmileWeb/passcode.do" \
-d"org.apache.struts.taglib.html.TOKEN=#{token}" \
...
curl_cmd = %%curl "https://welcome23.smile.co.uk/SmileWeb/loginSpi.do" \
-d"org.apache.struts.taglib.html.TOKEN=#{token}" \
-b"#{cookie_path}"%
...
curl_cmd = %%curl "https://welcome23.smile.co.uk#{current_account_url}" \
-b"#{cookie_path}"% 
