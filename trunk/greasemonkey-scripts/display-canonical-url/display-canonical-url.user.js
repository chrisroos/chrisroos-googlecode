...
// @description   Scans the head of the document for the first link element with a rel=canonical attribute/value and displays the value of the href attribute (the canonical url) for that element.  It will additionally link to the canonical url if it's different to the current location.
// @include       *
// ==/UserScript==
