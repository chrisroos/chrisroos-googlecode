...
Begin VB.Form frmPostOfficesList 
   Caption         =   "Post Offices List"
   ClientHeight    =   3240
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4065
   Icon            =   "frmPostOfficesList.frx":0000
   LinkTopic       =   "Form2"
   MDIChild        =   -1  'True
   ScaleHeight     =   3240
   ScaleWidth      =   4065
   ...
   End
End
Attribute VB_Name = "frmPostOfficesList"
...
Private Sub Form_Load()
    ...
    Set mshGrid.DataSource = objConsineer.GetData("vw_PostOffices_List", g_strDatabasePath & gc_strDatabase)
