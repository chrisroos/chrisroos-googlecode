...
{
	if ((event.type=='keypress' && event.keyCode == 13) || event.type == 'mouseup') {
		var realm = document.getElementById('domain').value;
		var password = document.getElementById('password').value;
		var hashedPassword = new SPH_HashedPassword(password, realm)
