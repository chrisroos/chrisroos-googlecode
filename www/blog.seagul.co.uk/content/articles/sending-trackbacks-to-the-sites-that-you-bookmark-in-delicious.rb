...
attributes = {
  ...
  :published_at => Time.parse('2008-02-04 09:53:00')
}
...
The "trackback specification":http://www.sixapart.com/pronet/docs/trackback_spec states that I must send the "permalink":http://en.wikipedia.org/wiki/Permalink of my 'post' to the resource that I'm tracking back to.  By design, individual posts (or bookmarks) in "del.icio.us":http://del.icio.us aren't addressable by a "URI":http://en.wikipedia.org/wiki/Uniform_Resource_Identifier.  So, the first step was to "add permalinks to my del.icio.us bookmarks":http://blog.seagul.co.uk/articles/2007/09/04/permalinks-for-del-icio-us-bookmarks-posts.  This was a kludgy, manual fix that added permalinks to all my old bookmarks: it didn't work for any new bookmarks.

From here, I spent some time "hacking around with the del.icio.us firefox extension":http://blog.seagul.co.uk/articles/2007/09/05/patching-the-del-icio-us-firefox-extension-to-add-permalinks to get it to automatically generate these permalink tags.

The final stage was to "extract the hacked-in functionality into its own extension":http://blog.seagul.co.uk/articles/2007/12/18/extracting-my-del-icio-us-permalinks-functionality-into-its-own-firefox-extension (an extension of an extension - cool huh).
